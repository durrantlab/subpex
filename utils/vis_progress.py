...
def plot_histogram(results, value, title, directory=None): # TODO: Erich - refactor plot_histogram function
    min_1 = None
    max_1 = None
...
def plot_stuff(jd, min_md_jd, max_md_jd, average_jd, jd_max, jd_min, jd_sd): # TODO: Erich - this plot needs to  be redone
...
def obtain_paths_highest_rmsd_jd_weight(max_rmsd, max_jd, max_weight, reverse_iterations): # TODO: Erich - I may need to erase this plot
    """
